...
public class StockQuotesRequestV2 extends QuotesRequestV2<StockQuotesDataV2> {
    ...
    public StockQuotesRequestV2(String query) {
        super(query, StockQuotesRequestV2.DEFAULT_PROPERTIES);
    }

    @Override
    protected StockQuotesDataV2 parseCSVLine(String line) {
        ...
        return new StockQuotesDataV2(parsedLine.toArray(new String[this.properties.size()]));
    }
