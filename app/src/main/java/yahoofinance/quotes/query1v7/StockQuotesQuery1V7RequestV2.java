...
public class StockQuotesQuery1V7RequestV2  extends QuotesRequestV2<StockV2> {
    private static final BigDecimal ONE_HUNDRED = new BigDecimal(100);

    public StockQuotesQuery1V7RequestV2(String symbols) {
        super(symbols);
    }

    @Override
    protected StockV2 parseJson(JsonNode node) {
        String symbol = node.get("symbol").asText();
        StockV2 stock = new StockV2(symbol);
